...
export function Plugins({ placeholder }: { placeholder?: string }) {
	...
	const editorPlaceholder = placeholder || "Press / for commands...";
	...
	return (
		<div className="relative">
			...
			<div className="relative">
					...
					contentEditable={
						<div className="">
							<div className="" ref={onRef}>
								<ContentEditable placeholder={editorPlaceholder} />
							</div>
						</div>
					}
				...
				{/* {!isMobile && <DraggableBlockPlugin anchorElem={floatingAnchorElem} />} */}
				<ClickableLinkPlugin />
				<AutoLinkPlugin />
				<LinkPlugin />
